// Generated by tools/generate_guide_english_translations.mjs.
...
export const GUIDE_ENGLISH_TRANSLATIONS: Readonly<Record<string, string>> = {
  ...
  '¿En qué orden imprime este código?': 'In what order do you print this code?',
  ...
  '¿Qué diferencia hay entre syntax error y runtime error?':
