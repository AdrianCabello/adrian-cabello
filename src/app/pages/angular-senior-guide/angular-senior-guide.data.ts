...
export const STUDY_TOPICS: readonly StudyTopic[] = [
  {
    id: 'mapa-de-la-entrevista-senior',
    number: '01',
    groupId: 'enfoque-senior',
    title: 'Mapa de la entrevista Senior',
    intro:
      'Una entrevista Senior evalúa criterio técnico, capacidad para reducir riesgo y comunicación. La respuesta fuerte explica el mecanismo, nombra el trade-off y conecta la decisión con un caso real.',
    theory: [
      'Una respuesta técnica sólida contiene cuatro capas: una definición breve, el mecanismo interno, una decisión aplicada y el límite o alternativa de esa decisión.',
      'Angular define el modelo de componentes, templates, inyección de dependencias y detección de cambios. Cada equipo decide la estructura de carpetas, los límites de features y la estrategia de estado según su producto.',
      'El volumen de datos, la frecuencia de actualización, el SEO, la latencia, la accesibilidad, la seguridad y el soporte de navegadores cambian la solución correcta. Una decisión sin estas restricciones sólo describe una preferencia.',
      'Un caso real aporta evidencia sobre una decisión. Formularios dinámicos, migraciones, incidentes o mejoras de rendimiento permiten explicar contexto, acción, resultado y trade-offs con datos concretos.',
    ],
    questions: [
      {
        question: '¿Qué diferencia una respuesta Senior?',
        answer:
          'Una respuesta Senior muestra cómo tomarías la decisión, qué medirías y qué costo aceptás. Evitá recitar APIs sin explicar cuándo fallan.',
      },
      {
  ...
  },
  {
    ...
    intro:
      'El event loop coordina el stack con colas y APIs del host. Una entrevista Senior suele pedir el orden exacto de logs, cancelación y manejo de carreras.',
    theory: [
    ...
    questions: [
      {
        ...
        answer:
          'Ejecutá primero el stack síncrono, después todas las microtasks creadas, y recién entonces timers. Cada callback puede encolar más microtasks antes de la siguiente task.',
      },
      {
        question: '¿Promise u Observable?',
        answer:
          'Promise representa un settlement y empieza al crearse. Observable puede producir varios valores, suele ser lazy y permite unsubscribe y operadores de concurrencia.',
      },
      {
        question: '¿Cómo cancelás fetch?',
        answer:
          'Creo un AbortController, paso `signal` a fetch y llamo `abort`. Trato `AbortError` como cancelación, no como fallo del producto.',
      },
      {
        question: '¿Qué diferencia hay entre syntax error y runtime error?',
        answer:
          'El parser detecta un syntax error antes de ejecutar esa unidad. Un runtime error aparece al evaluar una operación válida en sintaxis con un estado inválido.',
      },
      {
