    ...
    "questions": [
      {
        ...
        "answer": "La etiqueta define el elemento; el atributo configura información o comportamiento en su start tag. Una property DOM representa el estado vivo y puede diferir del atributo inicial."
      },
      {
        "question": "¿`id` o `class`?",
        "answer": "`id` identifica un elemento dentro del documento y sirve para relaciones, fragmentos y labels. `class` agrupa elementos para estilos o comportamiento."
      },
      {
        "question": "¿Cómo crear un formulario accesible?",
        "answer": "Asocio labels, agrupo opciones con fieldset/legend, uso tipos y autocomplete, explico errores y muevo foco cuando el flujo lo requiere."
      },
      {
        "question": "¿`ol` o `ul`?",
        "answer": "`ol` comunica que el orden modifica el significado; `ul` agrupa elementos sin secuencia semántica."
      },
      {
        "question": "¿Cuándo usás un enlace y cuándo un botón?",
        "answer": "Un enlace con `href` cambia ubicación y conserva acciones nativas como abrir en otra pestaña. Un botón ejecuta una acción en la interfaz. Elegir el elemento correcto aporta teclado, rol y expectativas sin recrearlos con JavaScript."
      },
      {
        "question": "¿Qué aporta la validación nativa de formularios?",
        "answer": "Atributos como `required`, `type`, `min`, `max` y `pattern` expresan restricciones y permiten feedback del navegador. La aplicación puede personalizar mensajes, pero el servidor debe repetir la validación porque el cliente se puede modificar."
      }
    ],
    ...
    "questions": [
      {
        ...
        "answer": "Flexbox distribuye elementos a lo largo de un eje y permite wrapping. Grid define una estructura bidimensional. Una interfaz puede usar ambos en niveles distintos."
      },
      {
        "question": "¿Por qué `z-index: 9999` no funciona?",
        "answer": "El elemento puede vivir dentro de un stacking context que queda debajo de otro. Comparo contextos ancestros antes de subir el número."
      },
      {
        "question": "¿`display:none` o `visibility:hidden`?",
        "answer": "`display:none` elimina la caja; `visibility:hidden` conserva su espacio. Si necesitás ocultar solo visualmente y mantener lectura, uso un patrón visually-hidden probado."
      },
      {
        "question": "¿Cómo evitás CSS frágil?",
        "answer": "Reduzco especificidad, defino tokens y layers, limito alcance, documento variantes y pruebo estados, tamaños, temas y contenido real."
      },
      {
        "question": "¿Cómo diagnosticás un problema de `z-index`?",
        "answer": "Identifico los stacking contexts de ambos elementos y comparo sus ancestros, no sólo sus números. `transform`, `opacity`, `isolation` y ciertos elementos posicionados crean contextos que limitan dónde compite un descendiente."
      },
      {
        "question": "¿Media query o container query?",
        "answer": "Una media query responde al viewport o a preferencias del usuario. Una container query responde al espacio disponible para el componente. La segunda permite reutilizar la misma pieza en layouts distintos sin conocer la página que la contiene."
      }
    ],
    ...
    "questions": [
      {
        ...
        "answer": "`var` usa scope de función y permite redeclaración. `let` y `const` usan scope de bloque y temporal dead zone. `const` impide reasignar la variable, pero el valor referenciado puede mutar."
      },
      {
        "question": "¿Por qué `[] == false` da true?",
        "answer": "`==` convierte el array a primitivo, produce una cadena vacía y después convierte ambos lados a número: cero y cero. Con `===` el resultado es false porque los tipos difieren."
      },
      {
        "question": "¿Arrow function o función normal?",
        "answer": "Uso arrow para callbacks que necesitan el `this` exterior. Uso función normal para métodos dinámicos, constructores o APIs que asignan receiver."
      },
      {
        "question": "¿Shallow copy o deep copy?",
        "answer": "Spread y `Object.assign` copian el primer nivel. Las referencias anidadas siguen compartidas. Elijo una copia profunda solo si el modelo y el costo lo justifican."
      },
      {
        "question": "¿Por qué existe la Temporal Dead Zone?",
        "answer": "El binding de `let` o `const` existe desde el inicio del bloque, pero JavaScript impide leerlo antes de ejecutar su inicialización. Así detecta accesos prematuros en lugar de devolver `undefined` como ocurre con `var`."
      },
      {
        "question": "¿Usarías alguna vez `==`?",
        "answer": "Aceptaría `value == null` si el estándar del equipo permite comprobar `null` y `undefined` juntos. Para el resto prefiero `===` porque evita que quien lee tenga que reconstruir la tabla de coerción."
      }
    ],
    ...
    "questions": [
      {
        ...
        "answer": "`class` organiza herencia y métodos con sintaxis más clara; el runtime resuelve métodos mediante prototipos. Conocer el modelo explica `instanceof`, shadowing y métodos compartidos."
      },
      {
        "question": "¿`map` o `forEach`?",
        "answer": "`map` crea una colección transformada y exige usar el retorno. `forEach` expresa un efecto por elemento y devuelve `undefined`."
      },
      {
        "question": "¿`Map` o objeto?",
        "answer": "`Map` acepta cualquier clave, preserva orden de inserción y ofrece size e iteración directa. Un objeto encaja en records con claves string/symbol y serialización JSON."
      },
      {
        "question": "¿Qué muta un array?",
        "answer": "`push`, `pop`, `shift`, `unshift`, `splice`, `sort`, `reverse`, `fill` y `copyWithin`. `map`, `filter`, `slice`, `concat` y los métodos `to*` crean otro array."
      },
      {
        "question": "¿Qué pierde una copia con spread?",
        "answer": "Spread copia propiedades enumerables propias del primer nivel. Las referencias anidadas siguen compartidas y la copia no conserva descriptores completos ni comportamiento interno de todos los objetos. Primero defino qué parte del modelo necesita una nueva identidad."
      },
      {
        "question": "¿Cuándo evitás `map`, `filter` y `reduce` encadenados?",
        "answer": "Cada operador puede recorrer y asignar otra colección. En una ruta caliente o una lista grande, un solo loop puede reducir memoria y trabajo. Mantengo la cadena cuando su claridad pesa más que ese costo medido."
      }
    ]
  },
  {
    ...
    "theory": [
      ...
      "Los errores pueden pertenecer al dominio, validación, autenticación, red, timeout, cancelación o a un bug. Esa clasificación define si corresponde reintentar, pedir una corrección al usuario, cerrar la sesión o registrar el incidente. La propiedad `cause` conserva el error original al envolverlo.",
      "Debounce ejecuta una operación después de un período sin eventos; throttle limita cuántas ejecuciones caben en un intervalo. Las opciones leading y trailing determinan si se emite al comienzo, al final o en ambos puntos, y el cleanup cancela trabajo pendiente al destruir el consumidor.",
      "Una race condition aparece cuando dos operaciones concurrentes modifican el mismo estado y el resultado depende del orden de finalización. La cancelación, un identificador de versión o la comparación contra la solicitud vigente evita que una respuesta antigua reemplace datos nuevos.",
      "El trabajo intensivo de CPU ocupa el main thread y retrasa input, layout y render. Dividirlo en tareas pequeñas permite ceder tiempo al navegador; un Web Worker lo mueve a otro thread a cambio de serialización y mensajes. `async/await` no cambia de thread."
    ],
    "questions": [
      {
        "question": "¿En qué orden imprime este código?",
        "answer": "Ejecutá primero el stack síncrono, después todas las microtasks creadas, y recién entonces timers. Cada callback puede encolar más microtasks antes de la siguiente task."
      },
      {
        "question": "¿Promise u Observable?",
        "answer": "Promise representa un settlement y empieza al crearse. Observable puede producir varios valores, suele ser lazy y permite unsubscribe y operadores de concurrencia."
      },
      {
        "question": "¿Cómo cancelás fetch?",
        "answer": "Creo un AbortController, paso `signal` a fetch y llamo `abort`. Trato `AbortError` como cancelación, no como fallo del producto."
      },
      {
        "question": "¿Qué diferencia hay entre syntax error y runtime error?",
        "answer": "El parser detecta un syntax error antes de ejecutar esa unidad. Un runtime error aparece al evaluar una operación válida en sintaxis con un estado inválido."
      },
      {
        "question": "¿Cómo puede una cadena de microtasks bloquear la interfaz?",
        "answer": "El navegador vacía la cola de microtasks antes de avanzar al siguiente task y al render. Una cadena que agenda otra microtask puede retrasar input y pintura. Divido el trabajo y cedo al scheduler cuando necesito que el navegador procese otra tarea."
      },
      {
        "question": "¿Qué ocurre si falla una promesa dentro de `Promise.all`?",
        "answer": "`Promise.all` rechaza al recibir el primer rechazo observable, pero las operaciones restantes continúan salvo que su API admita cancelación. Uso `allSettled` cuando necesito el resultado de cada operación y `AbortController` cuando debo detener I/O compatible."
      }
    ],
    ...
    "questions": [
      {
        ...
        "answer": "`unknown` obliga a validar o estrechar el tipo antes de usarlo. `any` permite operaciones inválidas y propaga huecos por toda la aplicación."
      },
      {
        "question": "¿`interface` o `type`?",
        "answer": "Ambos describen formas de objetos. `interface` admite declaration merging y extensión orientada a contratos; `type` también representa unions, intersections, tuplas y tipos calculados. La consistencia del código y la capacidad necesaria deciden la elección."
      },
      {
        "question": "¿Qué diferencia existe entre `satisfies` y `as`?",
        "answer": "`satisfies` comprueba que el valor cumple un contrato y conserva su inferencia. `as` fuerza una interpretación del tipo y puede ocultar una incompatibilidad. Uso assertions sólo cuando el runtime aporta una garantía que el compilador no puede demostrar."
      },
      {
        "question": "¿Cómo diseñás un generic útil?",
        "answer": "El generic debe conservar una relación entre valores, por ejemplo entre entrada y salida o entre una key y su propiedad. Si el parámetro de tipo aparece una sola vez, quizá una unión o un tipo concreto comunique mejor el contrato."
      }
    ],
    ...
    "questions": [
      {
        ...
        "answer": "Migraría por incrementos soportados, con tests, presupuestos de bundle y observabilidad. Priorizo seguridad, compatibilidad y APIs deprecadas; después adopto sintaxis nueva."
      },
      {
        "question": "¿Standalone elimina los módulos?",
        "answer": "Elimina la necesidad de NgModules para declarar componentes. Los módulos todavía pueden agrupar APIs heredadas o librerías. Standalone simplifica dependencias y lazy loading."
      },
      {
        "question": "¿Qué revisarías antes de activar zoneless?",
        "answer": "Busco mutaciones que dependen de ZoneJS, librerías que actualizan campos sin notificar y usos directos de APIs externas. Migro el estado visible a signals, `AsyncPipe` o marcas explícitas y comparo tests y métricas antes de retirar ZoneJS."
      },
      {
        "question": "¿Cómo decidís qué contenido cargar con `@defer`?",
        "answer": "Difiero contenido costoso que no participa del primer objetivo visual. Elijo trigger y prefetch según la probabilidad de uso, reservo espacio para evitar CLS y mido LCP, transferencia e interacción en una build de producción."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Un input expresa dependencia del padre y mantiene el componente reutilizable. Un servicio sirve para estado compartido por ramas distantes o un dominio. No ocultes datos de presentación globalizando todo."
      },
      {
        "question": "¿Content projection o input TemplateRef?",
        "answer": "`ng-content` funciona para slots fijos y ergonomía declarativa. `TemplateRef` permite repetir, parametrizar o elegir plantillas en tiempo de ejecución."
      },
      {
        "question": "¿Qué debería formar parte de la API pública de un componente?",
        "answer": "Sólo inputs, outputs y slots que representan variaciones reales del producto. Si una opción expone detalles internos o combina estados inválidos, prefiero dividir responsabilidades o modelar una unión más precisa."
      },
      {
        "question": "¿Cuándo crearías una directiva en lugar de un componente?",
        "answer": "Creo una directiva cuando necesito añadir comportamiento a un elemento existente sin imponer markup. Creo un componente cuando la unidad posee estructura visual, estado y una API que deben evolucionar juntos."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "El constructor pertenece a TypeScript y DI. `ngOnInit` pertenece al ciclo de Angular y recibe inputs listos. Evitá I/O en ambos si un resolver, store o recurso expresa mejor la carga."
      },
      {
        "question": "¿Cómo evitás leaks?",
        "answer": "Uso `AsyncPipe`, signals o `takeUntilDestroyed`; limpio APIs externas con `DestroyRef.onDestroy`. Después verifico navegación repetida con profiler y tests."
      },
      {
        "question": "¿`ngAfterViewInit` o `afterNextRender` para medir DOM?",
        "answer": "`ngAfterViewInit` confirma que Angular inicializó la vista, pero una medición puede depender de un render posterior. `afterNextRender` ejecuta trabajo después del siguiente render del árbol y permite separar fases de escritura y lectura."
      },
      {
        "question": "¿Qué ventaja aporta `DestroyRef`?",
        "answer": "Coloca la limpieza junto al recurso que la necesita y evita concentrar teardown sin contexto en `ngOnDestroy`. Lo uso con listeners, observers y `takeUntilDestroyed` para vincular su vida al contexto de inyección."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "No. OnPush cambia cuándo Angular verifica la vista. La inmutabilidad facilita detectar cambios por referencia y evita estado compartido corrupto."
      },
      {
        "question": "¿Cuándo usar `effect`?",
        "answer": "Para logging, almacenamiento, canvas, APIs del navegador o integración externa. Las derivaciones de UI pertenecen a `computed`."
      },
      {
        "question": "¿Qué rompe al quitar ZoneJS?",
        "answer": "Código que muta campos sin emitir una notificación compatible, además de dependencias en eventos de `NgZone`. Migraría estado a signals o marcaría la vista."
      },
      {
        "question": "¿Por qué una mutación profunda puede no actualizar la vista?",
        "answer": "Un signal compara el valor nuevo con el anterior mediante `Object.is` por defecto. Mutar una propiedad conserva la referencia y no publica otro valor. Creo una nueva referencia o modelo el campo como un signal independiente."
      },
      {
        "question": "¿Cómo elegís entre `computed` y `effect`?",
        "answer": "`computed` calcula estado derivado y sólo depende de otros signals. `effect` sincroniza el grafo reactivo con una frontera externa como storage, logging o canvas. No copio estado derivado mediante efectos."
      }
    ],
    ...
    "questions": [
      {
        ...
        "answer": "Es singleton dentro del injector que lo provee. Dos injectors pueden crear dos instancias. La frase 'singleton global' omite el scope."
      },
      {
        "question": "¿Por qué usar InjectionToken?",
        "answer": "Permite inyectar configuración, funciones o interfaces borradas en runtime. El token conserva identidad y puede definir factory y tipo."
      },
      {
        "question": "¿Qué diferencia hay entre `useClass` y `useExisting`?",
        "answer": "`useClass` pide al injector que construya otra instancia de la clase indicada. `useExisting` crea un alias hacia una instancia registrada. Uso el alias cuando dos tokens deben compartir identidad y estado."
      },
      {
        "question": "¿Cómo afecta el lugar del provider a una feature?",
        "answer": "El injector que registra el provider define su alcance y vida útil. Un provider de componente aísla instancias por subárbol; uno de ruta puede vivir con la feature lazy; root comparte la instancia en la aplicación."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Anida ciclos de vida y errores, complica cancelación y crea carreras. Un operador de flattening expresa la política y devuelve una sola subscription."
      },
      {
        "question": "¿Cómo cancelás una búsqueda anterior?",
        "answer": "Debounceo, elimino duplicados y uso `switchMap`. El unsubscribe cancela la petición XHR/fetch cuando el backend y el cliente lo permiten."
      },
      {
        "question": "¿`switchMap` cancela el trabajo en el servidor?",
        "answer": "Unsubscribe detiene la observación y puede abortar el request si la fuente integra cancelación, como `HttpClient`. El servidor puede haber iniciado el trabajo. Las operaciones con efectos necesitan idempotencia o un protocolo de cancelación propio."
      },
      {
        "question": "¿Qué riesgo tiene `shareReplay`?",
        "answer": "Puede retener el último valor y mantener viva la suscripción más tiempo del esperado. Defino buffer, `refCount` y política de reset según el ciclo de vida. También decido cómo invalidar errores y datos stale."
      }
    ],
    ...
    "questions": [
      {
        ...
        "answer": "Cuando varios flujos comparten estado, necesitás trazabilidad, efectos coordinados o reglas complejas. Para un formulario aislado, un store global aumenta costo sin beneficio."
      },
      {
        "question": "¿Qué nunca guardarías en el store?",
        "answer": "Derivaciones recalculables, objetos no serializables sin necesidad y estado DOM efímero. Guardaría la fuente mínima de verdad."
      },
      {
        "question": "¿Cómo separás server state de client state?",
        "answer": "Server state es una copia de datos remotos y requiere stale time, caché e invalidación. Client state nace en la interacción, por ejemplo filtros o pasos de un wizard. Separarlos evita que un store trate ambos ciclos de vida con la misma política."
      },
      {
        "question": "¿Qué señales justifican introducir NgRx?",
        "answer": "Lo considero cuando varios flujos escriben el mismo dominio, necesito trazabilidad de eventos, efectos coordinados o reglas de actualización compartidas. Un formulario local o una pantalla aislada no justifican ese costo por sí solos."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "No. Un usuario controla el cliente. El guard mejora UX y evita navegación accidental; la API autoriza cada operación."
      },
      {
        "question": "¿Resolver o carga en componente?",
        "answer": "Resolver cuando la vista no tiene sentido sin el dato o necesitás coherencia antes de activar. Carga en componente para streaming, skeletons o contenido parcial."
      },
      {
        "question": "¿Qué diferencia hay entre `CanMatch` y `CanActivate`?",
        "answer": "`CanMatch` decide si una configuración de ruta puede participar del matching y permite probar otra ruta. `CanActivate` actúa después de elegirla y decide si se activa. Ninguno reemplaza la autorización del servidor."
      },
      {
        "question": "¿Cuándo evitarías un resolver?",
        "answer": "Evito bloquear navegación para datos secundarios o lentos. La pantalla puede mostrar estructura, loading y recuperación parcial. Uso resolver cuando el dato define si la ruta tiene sentido o cuando entrar sin él produciría un estado inválido."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Defino un schema tipado, componentes por tipo de campo, reglas de visibilidad derivadas y validadores registrables. Separo datos, layout y comportamiento; pruebo el motor con casos de contrato."
      },
      {
        "question": "¿Qué falla en un CVA?",
        "answer": "Emitir durante `writeValue`, olvidar estado disabled o no marcar touched. Eso crea loops y rompe la semántica del formulario."
      },
      {
        "question": "¿Qué contrato debe cumplir un `ControlValueAccessor`?",
        "answer": "Debe escribir el valor externo sin emitir un cambio de usuario, registrar callbacks de cambio y touched, y respetar el estado disabled. También necesita una representación clara para null y valores parciales."
      },
      {
        "question": "¿Cómo evitás carreras en validación asíncrona?",
        "answer": "Modelo la validación como un flujo que cancela la consulta anterior al cambiar el valor. Aplico debounce cuando corresponde y distingo error de transporte, valor inválido y estado pendiente en la interfaz."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "En una capa de autenticación coordinada por interceptor, con una sola renovación en vuelo y cola controlada. Evito loops y limpio sesión si falla el refresh."
      },
      {
        "question": "¿Cómo tipar una respuesta HTTP?",
        "answer": "El generic de HttpClient expresa la expectativa, no valida el servidor. En una frontera crítica valido y transformo el DTO antes de exponerlo."
      },
      {
        "question": "¿Por qué importa el orden de los interceptors?",
        "answer": "Cada interceptor envuelve al siguiente. El request avanza en el orden registrado y la respuesta vuelve en orden inverso. Autenticación, retry, caché y logging pueden cambiar su comportamiento según esa composición."
      },
      {
        "question": "¿Cómo invalidás una caché después de una mutación?",
        "answer": "Relaciono cada escritura con las keys afectadas. Puedo invalidar, actualizar de forma optimista o reemplazar con la respuesta del servidor. La política incluye rollback y evita borrar datos de dominios no relacionados."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "question": "¿DOM y BOM?",
        "answer": "DOM modela el documento. BOM reúne objetos y APIs del entorno del navegador, como history, location y navigator."
      },
      {
        "question": "¿localStorage, sessionStorage o IndexedDB?",
        "answer": "Elijo localStorage para pocas preferencias no sensibles, sessionStorage para vida de pestaña e IndexedDB para volumen, queries y trabajo asíncrono."
      },
      {
        "question": "¿Qué es CORS?",
        "answer": "Una política del navegador que permite al servidor declarar qué origins pueden leer una respuesta. No protege endpoints de clientes no navegador ni reemplaza autorización."
      },
      {
        "question": "¿Reflow y repaint?",
        "answer": "Layout recalcula geometría; paint genera píxeles; compositing combina capas. Cambios y lecturas intercaladas pueden forzar trabajo síncrono."
      },
      {
        "question": "¿Qué produce un forced synchronous layout?",
        "answer": "Una escritura invalida estilos o layout y una lectura geométrica posterior, como `getBoundingClientRect`, obliga al navegador a calcular el resultado en ese momento. Agrupo lecturas y escrituras para evitar repetir ese trabajo dentro de un loop."
      },
      {
        "question": "¿CORS protege una API contra clientes no autorizados?",
        "answer": "No. CORS controla qué respuestas puede leer JavaScript desde otro origin en un navegador. Un script de servidor puede llamar al endpoint. La API todavía necesita autenticación, autorización y validación."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Uso sus límites y dependency inversion donde protegen reglas de negocio. Evito copiar capas backend si solo agregan archivos y mapeos."
      },
      {
        "question": "¿Cuándo extraer una librería?",
        "answer": "Cuando existe un contrato estable y más de un consumidor real, o cuando el límite necesita ownership y tests propios. Extraer por anticipación congela APIs inmaduras."
      },
      {
        "question": "¿Cómo detectás una frontera de feature incorrecta?",
        "answer": "Aparecen imports circulares, cambios coordinados entre carpetas supuestamente independientes y servicios compartidos que conocen todos los dominios. Reubico el comportamiento según ownership y expongo una API pequeña por frontera."
      },
      {
        "question": "¿Qué problema genera una carpeta `shared` sin reglas?",
        "answer": "Recibe componentes, modelos y servicios de dominios distintos hasta convertirse en una dependencia global. Separo primitives reutilizables de contratos de negocio y dejo cada modelo cerca de la feature que lo posee."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "En Angular proveo el servicio en un injector compartido. La garantía vale dentro de ese scope; providers locales o múltiples aplicaciones crean otras instancias."
      },
      {
        "question": "¿Facade sobre NgRx?",
        "answer": "Puede estabilizar la API de la feature y ocultar detalles del store. También puede esconder capacidades y duplicar nombres. La uso cuando protege un límite real."
      },
      {
        "question": "¿Cómo aplicás Dependency Inversion en Angular?",
        "answer": "El consumidor depende de un contrato expresado por una clase abstracta o `InjectionToken`. La configuración conecta ese contrato con una implementación. Puedo cambiar la frontera en tests o por entorno sin enseñar detalles al consumidor."
      },
      {
        "question": "¿Cuándo una facade empeora el diseño?",
        "answer": "Una facade que sólo renombra cada método añade navegación sin reducir acoplamiento. La uso cuando concentra un caso de uso, oculta coordinación entre dependencias o protege a la UI de cambios del subsistema."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Defino la interacción lenta, reproduzco con datos reales y grabo performance. Identifico red, scripting, layout o memoria; cambio una causa y vuelvo a medir."
      },
      {
        "question": "¿`trackBy` sigue existiendo?",
        "answer": "En `*ngFor` sí. El control flow moderno usa `track`. Ambos preservan identidad DOM; una clave inestable anula el beneficio."
      },
      {
        "question": "¿Cómo empezás una investigación de rendimiento?",
        "answer": "Defino una interacción y una métrica, reproduzco con una build de producción y capturo un perfil. Después separo red, scripting, render y memoria. Optimizo el cuello medido y vuelvo a comparar bajo las mismas condiciones."
      },
      {
        "question": "¿OnPush corrige una tarea larga de JavaScript?",
        "answer": "No. OnPush puede reducir verificaciones de vistas, pero una función que ocupa el main thread sigue bloqueando input y render. Divido el trabajo, reduzco su complejidad o lo muevo a un Worker si el costo de mensajes lo permite."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Mejora entrega de HTML y SEO, pero agrega servidor e hidratación. Puede empeorar TTFB o interacción si el backend y el bundle no acompañan."
      },
      {
        "question": "¿Qué causa hydration mismatch?",
        "answer": "HTML diferente entre servidor y cliente, fechas o random no deterministas, DOM manipulado antes de hidratar y markup inválido."
      },
      {
        "question": "¿Cómo elegís estrategia de rendering por ruta?",
        "answer": "Uso SSG para contenido estable, SSR para HTML dependiente de la request y CSR para áreas privadas donde el shell aporta poco al servidor. Evalúo SEO, personalización, latencia, caché y costo operativo por ruta."
      },
      {
        "question": "¿Qué causa un hydration mismatch?",
        "answer": "El cliente produce un árbol distinto al HTML del servidor por datos no deterministas, acceso al navegador o markup condicional. Comparto el estado inicial, aíslo APIs del browser y mantengo estable la estructura hasta hidratar."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "El riesgo más caro: regla de dominio, permiso, pago, migración o interacción que ya falló. La cobertura porcentual no reemplaza esa priorización."
      },
      {
        "question": "¿Unit test de un componente con servicio?",
        "answer": "Sustituyo la frontera del servicio, ejecuto la interacción por el DOM y verifico el resultado visible y la llamada relevante. No pruebo Angular."
      },
      {
        "question": "¿Qué probás en una unidad y qué dejás para integración?",
        "answer": "Una unidad cubre reglas puras y estados con pocas fronteras. Un test de integración comprueba template, DI, router o HTTP cuando su composición forma parte del comportamiento. Elijo el nivel más bajo que todavía puede detectar el fallo real."
      },
      {
        "question": "¿Cómo eliminás un test asíncrono flaky?",
        "answer": "Controlo reloj, scheduler y respuestas externas. Espero una condición observable en lugar de usar delays arbitrarios, cierro requests pendientes y elimino estado compartido entre casos."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Reduce XSS al escapar y sanitizar contextos conocidos. DOM APIs directas, bypass, librerías y HTML externo reabren el riesgo."
      },
      {
        "question": "¿LocalStorage o cookies para tokens?",
        "answer": "Depende del modelo de amenaza. Cookies HttpOnly reducen lectura por XSS y exigen CSRF controls. LocalStorage simplifica headers pero expone el token a JavaScript comprometido."
      },
      {
        "question": "¿Qué implica usar `bypassSecurityTrustHtml`?",
        "answer": "La llamada no sanitiza el contenido. Declara que la aplicación confía en esa fuente y evita la protección de Angular para ese sink. La restrinjo a una frontera revisada y prefiero transformar datos antes de producir HTML."
      },
      {
        "question": "¿Por qué un route guard no autoriza una operación?",
        "answer": "El usuario controla el cliente y puede omitir la navegación o llamar la API de forma directa. El guard mejora la experiencia. El servidor verifica identidad, permisos y ownership en cada operación."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Button aporta teclado, foco, rol y activación sin recrear comportamiento. Un div exige implementar y mantener todo eso."
      },
      {
        "question": "¿Cómo probás accesibilidad?",
        "answer": "Combino lint y axe con teclado real, lector de pantalla en flujos críticos y revisión de foco, contraste y nombres accesibles."
      },
      {
        "question": "¿Cuándo ARIA empeora un componente?",
        "answer": "ARIA puede contradecir la semántica nativa o anunciar un estado que el comportamiento no implementa. Empiezo por el elemento HTML correcto y agrego nombre, estado o relaciones sólo cuando falta información."
      },
      {
        "question": "¿Cómo manejás el foco de un modal?",
        "answer": "Muevo el foco a un punto útil dentro del diálogo, mantengo la navegación en su contenido, cierro con Escape cuando corresponde y devuelvo el foco al disparador. El diálogo también necesita nombre y fondo inerte."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Mantengo compatibilidad temporal de API, manejo chunk-load errors, uso assets versionados y evito borrar archivos previos antes de que expire su caché."
      },
      {
        "question": "¿Qué mirás después de un upgrade?",
        "answer": "Errores, tests, bundle, Web Vitals, warnings, cambios de browser support y dependencias pares. Después retiro compatibilidad obsoleta."
      },
      {
        "question": "¿Cómo diseñás un feature flag seguro?",
        "answer": "Defino owner, audiencia, fallback, métricas y fecha de retiro. El backend mantiene las reglas de autorización. Los dos caminos permanecen probados mientras el flag exista y retiro el código cuando termina el rollout."
      },
      {
        "question": "¿Publicarías source maps en producción?",
        "answer": "Los genero para relacionar errores minificados con el TypeScript, pero restrinjo su acceso al sistema de observabilidad. Asocio cada mapa con release y commit para simbolizar el stack correcto."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Aumento contexto observable, comparo versión, navegador y ruta de datos, y creo una hipótesis verificable. Evito cambios especulativos sin señal."
      },
      {
        "question": "¿Qué reportarías en un error HTTP?",
        "answer": "Endpoint normalizado, status, duración, correlation ID y operación. Redacto o elimino body, tokens y datos personales."
      },
      {
        "question": "¿Cómo usás un correlation ID desde el frontend?",
        "answer": "Propago un identificador permitido en requests y lo registro junto con ruta, release y acción. Backend y gateway conservan el mismo valor para unir el fallo visible con logs y traces sin guardar datos personales."
      },
      {
        "question": "¿Cómo confirmás un memory leak de navegación?",
        "answer": "Repito el recorrido, fuerzo garbage collection en un entorno de diagnóstico y comparo heap snapshots. Busco componentes retenidos, detached DOM nodes, listeners, timers y caches que conservan referencias."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Agrupo widgets por frecuencia y ownership, uso un servicio de conexión con multiplexing, normalizo eventos, aplico backpressure y renderizo con signals. Pauso streams invisibles y mido INP."
      },
      {
        "question": "Diseñá una librería de componentes",
        "answer": "Defino tokens de diseño, accesibilidad y APIs pequeñas; publico harnesses, documentación y semver. Pruebo keyboard, themes, SSR y breaking changes."
      },
      {
        "question": "¿Cómo elegís entre WebSocket, SSE y polling?",
        "answer": "WebSocket sirve para comunicación bidireccional, SSE para un stream servidor a cliente sobre HTTP y polling para cambios poco frecuentes o infraestructura simple. Comparo reconexión, proxies, orden, volumen y soporte del backend."
      },
      {
        "question": "¿Qué debe definir una estrategia de caché?",
        "answer": "Define key, TTL, invalidación, deduplicación y comportamiento stale. También explica cómo reconciliar optimistic updates, conflictos y cambios de paginación sin mezclar datos de usuarios o filtros distintos."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Alineo restricciones, comparo opciones con criterios, hago un spike si falta evidencia y documento la decisión. Después apoyo la opción acordada."
      },
      {
        "question": "¿Cómo manejaste feedback negativo?",
        "answer": "Describí el caso de modularización de formularios: escuchaste, revisaste estándares, refactorizaste por responsabilidad, pediste otra revisión y aplicaste el aprendizaje."
      },
      {
        "question": "¿Qué convierte un comentario de review en bloqueante?",
        "answer": "Bloqueo por corrección, seguridad, pérdida de datos, contrato roto o una deuda que impide operar el cambio. Marco preferencias como sugerencias y explico el riesgo para que el autor pueda aplicar el criterio."
      },
      {
        "question": "¿Qué incluís en un ADR?",
        "answer": "Registro contexto, restricciones, opciones consideradas, decisión y consecuencias. Añado owner y fecha de revisión cuando las condiciones pueden cambiar. El documento permite discutir la elección sin depender de memoria oral."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "No es la cantidad de APIs nombradas. Es poder explicar el mecanismo, elegir según restricciones, comparar alternativas y proponer una forma de validar el resultado. Por ejemplo, no basta con decir «uso `switchMap`»: hay que explicar que conserva sólo la operación interna más reciente y por qué esa política coincide con el problema."
      },
      {
        "question": "¿Qué hacés si no sabés una API exacta?",
        "answer": "Decí qué parte conocés, razoná desde el modelo de Angular y explicá cómo verificarías el detalle. Inventar una firma daña más que reconocer un borde."
      },
      {
        "question": "¿Cómo evitás responder «depende» sin tomar una posición?",
        "answer": "Nombrá dos o tres condiciones decisivas, fijá un escenario razonable y elegí. Por ejemplo: «si la página necesita SEO y contenido inicial rápido, elegiría SSR; si es una herramienta interna autenticada, empezaría con CSR». Después explicá qué dato haría cambiar la decisión."
      },
      {
        "question": "¿Cómo convertís una opinión en una decisión técnica defendible?",
        "answer": "Definí el objetivo, compará alternativas con los mismos criterios y acordá una señal de éxito. «Prefiero Signals» es una opinión; «uso Signals para estado local síncrono porque simplifica derivaciones y verifico el impacto con legibilidad, tests y profiling» es una decisión discutible y medible."
      },
      {
        "question": "¿Cómo estructurás una respuesta técnica extensa?",
        "answer": "Empiezo con una definición de una frase, explico el mecanismo y tomo una decisión para un escenario concreto. Cierro con el costo, la alternativa y cómo comprobaría el resultado. Si la pregunta es amplia, aviso esa estructura para que el entrevistador pueda profundizar donde le interese."
      },
      {
        "question": "¿Qué hacés cuando la pregunta no incluye suficiente contexto?",
        "answer": "Pido las restricciones que realmente cambian la respuesta: volumen, frecuencia de cambio, SEO, latencia, consistencia, seguridad y capacidad del equipo. Si no están disponibles, declaro un supuesto, elijo bajo ese escenario y digo qué dato me haría cambiar de opción."
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "answer": "Soy Frontend Developer especializado en Angular, con experiencia desde Angular 2 y equipos distribuidos. He diseñado formularios dinámicos a escala y productos de datos. Busco un rol donde pueda combinar arquitectura, entrega y mentoring."
      },
      {
        "question": "¿Por qué querés cambiar?",
        "answer": "Enfocá crecimiento, alcance técnico y tipo de producto. Evitá hablar mal del equipo actual o usar una respuesta genérica."
      },
      {
        "question": "¿Cómo evitás que una respuesta STAR se vuelva demasiado larga?",
        "answer": "Resumo situación y tarea en pocas frases. Dedico la mayor parte a mis decisiones, alternativas y coordinación. Cierro con un resultado medible y el aprendizaje que cambió mi trabajo posterior."
      },
      {
        "question": "¿Cómo contás un error sin debilitar tu perfil?",
        "answer": "Elijo un error real, explico la decisión que lo produjo y asumo mi parte. Describo cómo limité el impacto, qué señal agregué y qué cambio de código o proceso evitó repetirlo."
      }
    ]
  }
];
...
export const RAPID_QUESTIONS: readonly StudyQuestion[] = [
  ...
  },
  {
    ...
    "answer": "Devuelve `object` por compatibilidad histórica; verificá null de forma explícita."
  },
  {
  ...
  },
  {
    ...
    "answer": "Null suele expresar ausencia intencional; undefined expresa falta de valor o propiedad."
  },
  {
    "id": "rapid-005-truthy-y-falsy",
    "question": "¿Truthy y falsy?",
    "answer": "La conversión booleana determina branches; objetos y arrays vacíos son truthy."
  },
  {
    "id": "rapid-006-temporal-dead-zone",
    "question": "¿Temporal Dead Zone?",
    "answer": "Tramo del scope donde `let` o `const` existen pero no pueden leerse antes de inicializarse."
  },
  {
    "id": "rapid-007-hoisting",
    "question": "¿Hoisting?",
    "answer": "El entorno registra declaraciones antes de ejecutar; la disponibilidad depende del tipo de declaración."
  },
  {
    "id": "rapid-008-this",
    "question": "¿`this`?",
    "answer": "Receiver de una llamada según call-site, salvo arrow que captura el binding exterior."
  },
  {
    "id": "rapid-009-call-apply-bind",
    "question": "¿`call`, `apply`, `bind`?",
    "answer": "Call invoca con argumentos; apply con array-like; bind crea otra función con receiver o argumentos fijados."
  },
  {
  ...
  },
  {
    ...
    "answer": "Copia el primer nivel y comparte referencias anidadas."
  },
  {
  ...
  },
  {
    ...
    "question": "¿Prototipo?",
    "answer": "Objeto delegado que JavaScript consulta cuando una propiedad falta en el receiver."
  },
  {
  ...
  },
  {
    ...
    "answer": "Push, pop, shift, unshift, splice, sort, reverse, fill y copyWithin."
  },
  {
  ...
  },
  {
    ...
    "question": "¿Currying?",
    "answer": "Convierte una función de varios argumentos en una secuencia de funciones."
  },
  {
    "id": "rapid-022-debounce-o-throttle",
    "question": "¿Debounce o throttle?",
    "answer": "Debounce espera silencio; throttle limita ejecuciones por intervalo."
  },
  {
  ...
  },
  {
    ...
    "answer": "Promise rechazada sin handler; registrala y corregí la cadena, no la ocultes."
  },
  {
    "id": "rapid-028-dom",
    "question": "¿DOM?",
  ...
  },
  {
    "id": "rapid-029-bom",
    "question": "¿BOM?",
    "answer": "APIs del navegador fuera del documento, como history, location y navigator."
  },
  {
  ...
  },
  {
    ...
    "answer": "Listener en un ancestro que decide según el target; reduce listeners y cubre hijos dinámicos."
  },
  {
  ...
  },
  {
    ...
    "question": "¿IndexedDB?",
    "answer": "Base asíncrona del navegador para datos estructurados y mayor volumen."
  },
  {
  ...
  },
  {
    ...
    "answer": "Elemento cuyo nombre comunica rol y estructura al navegador y tecnologías asistivas."
  },
  {
    "id": "rapid-041-head",
    "question": "¿`head`?",
    "answer": "Metadata y recursos del documento, no contenido principal visible."
  },
  {
    "id": "rapid-042-alt",
    "question": "¿`alt`?",
    "answer": "Alternativa textual que depende de la función de la imagen; decorativas usan alt vacío."
  },
  {
    "id": "rapid-043-iframe-sandbox",
    "question": "¿`iframe sandbox`?",
    "answer": "Restringe capacidades del documento embebido y se abre con tokens explícitos."
  },
  {
    "id": "rapid-044-get-o-post-en-form",
    "question": "¿GET o POST en form?",
    "answer": "GET expresa consulta y deja datos en URL; POST envía body para una operación."
  },
  {
  ...
  },
  {
    ...
    "answer": "Peso de un selector dentro de la cascada después de origen, importancia y layer."
  },
  {
  ...
  },
  {
    ...
    "answer": "Participa en flujo y se fija dentro de su scroll container al cruzar un umbral."
  },
  {
  ...
  },
  {
    ...
    "answer": "Pseudo-clase selecciona estado; pseudo-elemento representa una parte generada o conceptual."
  },
  {
    "id": "rapid-055-bem",
    "question": "¿BEM?",
  ...
  },
  {
    ...
    "answer": "Preprocesador extiende sintaxis; framework aporta reglas, utilidades o componentes."
  },
  {
    "id": "rapid-057-media-o-container-query",
    "question": "¿Media o container query?",
    "answer": "Media consulta viewport/dispositivo; container consulta tamaño o estilo del contenedor."
  },
  {
    "id": "rapid-058-reflow",
    "question": "¿Reflow?",
    "answer": "Recalculo de geometría provocado por cambios o lecturas que requieren layout."
  },
  {
    "id": "rapid-059-cls",
    "question": "¿CLS?",
    "answer": "Movimiento inesperado de contenido; reservá espacio para imágenes y contenido asíncrono."
  },
  {
    "id": "rapid-060-componente-o-directiva",
    "question": "¿Componente o directiva?",
    "answer": "El componente posee vista; la directiva agrega comportamiento a un host."
  },
  {
    "id": "rapid-061-pipe-pura",
    "question": "¿Pipe pura?",
    "answer": "Angular puede reutilizar el resultado mientras no cambien las referencias de entrada."
  },
  {
    "id": "rapid-062-for-track",
    "question": "¿`@for track`?",
    "answer": "Asocia identidad de datos con nodos DOM para minimizar creación y conservar estado."
  },
  {
    "id": "rapid-063-computed-o-effect",
    "question": "¿`computed` o `effect`?",
    "answer": "`computed` deriva estado; `effect` sincroniza con una API externa."
  },
  {
    "id": "rapid-064-signal-o-behaviorsubject",
    "question": "¿Signal o BehaviorSubject?",
    "answer": "Signal para estado síncrono de UI; BehaviorSubject cuando necesitás semántica y operadores RxJS."
  },
  {
  ...
  },
  {
    ...
    "question": "¿`mergeMap`?",
    "answer": "Ejecuta inner observables en paralelo con concurrencia configurable."
  },
  {
    "id": "rapid-069-forkjoin",
    "question": "¿`forkJoin`?",
    "answer": "Emite una vez cuando todos completan; falla si alguno falla y no sirve para streams infinitos."
  },
  {
  ...
  },
  {
    ...
    "answer": "Comparte y reproduce valores; necesita política de refCount, error e invalidación."
  },
  {
  ...
  },
  {
    ...
    "answer": "Nueva instancia en el ElementInjector del componente y sus descendientes visibles."
  },
  {
  ...
  },
  {
    "id": "rapid-076-onpush",
    "question": "¿OnPush?",
    "answer": "Permite saltar subárboles hasta que una notificación relevante marca la vista."
  },
  {
    "id": "rapid-077-zoneless",
    "question": "¿Zoneless?",
    "answer": "Angular recibe notificaciones explícitas y evita usar ZoneJS para inferir cambios."
  },
  {
  ...
  },
  {
    ...
    "answer": "Ejecuta verificación local; su uso frecuente suele indicar un flujo defectuoso."
  },
  {
    "id": "rapid-080-standalone",
    "question": "¿Standalone?",
    "answer": "Componente que declara dependencias en imports y no necesita declaración en NgModule."
  },
  {
    "id": "rapid-081-lazy-route",
    "question": "¿Lazy route?",
    "answer": "Carga código al navegar a la feature, reduciendo el bundle inicial."
  },
  {
    "id": "rapid-082-guard",
    "question": "¿Guard?",
    "answer": "Control de navegación en cliente; no reemplaza autorización del servidor."
  },
  {
  ...
  },
  {
    ...
    "answer": "Modelo explícito y observable en TypeScript, apto para composición y validación compleja."
  },
  {
    "id": "rapid-085-cva",
    "question": "¿CVA?",
  ...
  },
  {
    ...
    "answer": "Validador que completa con errores o null; controlá cancelación y frecuencia."
  },
  {
    "id": "rapid-087-interceptor",
    "question": "¿Interceptor?",
    "answer": "Middleware de requests y responses para preocupaciones transversales."
  },
  {
    "id": "rapid-088-retry",
    "question": "¿Retry?",
  ...
  },
  {
    "id": "rapid-089-xss",
    "question": "¿XSS?",
    "answer": "Ejecución de script no confiable; evitá sinks peligrosos y mantené sanitización y CSP."
  },
  {
    "id": "rapid-090-csrf",
    "question": "¿CSRF?",
    "answer": "Petición autenticada inducida desde otro origen; afecta sobre todo credenciales automáticas como cookies."
  },
  {
    "id": "rapid-091-csp",
    "question": "¿CSP?",
    "answer": "Política del navegador que limita fuentes de scripts, estilos y otros recursos."
  },
  {
    "id": "rapid-092-trusted-types",
    "question": "¿Trusted Types?",
    "answer": "Restringe asignaciones a sinks DOM peligrosos a valores creados por políticas confiables."
  },
  {
    "id": "rapid-093-ssr",
    "question": "¿SSR?",
    "answer": "Render por request en servidor; ayuda SEO y HTML inicial, agrega costo operativo."
  },
  {
    "id": "rapid-094-ssg",
    "question": "¿SSG?",
  ...
  },
  {
    ...
    "question": "¿Hydration?",
    "answer": "Angular reutiliza HTML de servidor y conecta comportamiento cliente."
  },
  {
    "id": "rapid-096-defer",
    "question": "¿`@defer`?",
  ...
  },
  {
    ...
    "answer": "El bundler elimina código no alcanzable cuando el formato y las dependencias lo permiten."
  },
  {
    "id": "rapid-101-aot",
    "question": "¿AOT?",
    "answer": "Compila templates en build, reduce trabajo runtime y detecta errores antes."
  },
  {
  ...
  },
  {
    ...
    "answer": "Actualiza UI antes de confirmar y define rollback o reconciliación."
  },
  {
    "id": "rapid-106-facade",
    "question": "¿Facade?",
    "answer": "API estable que reduce superficie de un subsistema; puede ocultar demasiado si no protege un límite."
  },
  {
  ...
  },
  {
    "id": "rapid-109-srp",
    "question": "¿SRP?",
    "answer": "Una unidad concentra responsabilidades que cambian por el mismo motivo."
  },
  {
    "id": "rapid-110-dip",
    "question": "¿DIP?",
    "answer": "El código de alto nivel depende de abstracciones, no de detalles concretos."
  },
  {
    "id": "rapid-111-unknown",
    "question": "¿`unknown`?",
    "answer": "Tipo seguro para valor no validado; obliga a estrechar antes de usar."
  },
  {
    "id": "rapid-112-never",
    "question": "¿`never`?",
  ...
  },
  {
    ...
    "answer": "Crear nuevas referencias en lugar de mutar estado compartido; mejora previsibilidad y detección."
  },
  {
    "id": "rapid-116-object-freeze",
    "question": "¿`Object.freeze`?",
    "answer": "Congelación superficial; no protege objetos anidados sin trabajo adicional."
  },
  {
  ...
  },
  {
    "id": "rapid-119-e2e",
    "question": "¿E2E?",
    "answer": "Prueba un recorrido del usuario a través del sistema desplegado o equivalente."
  },
  {
    "id": "rapid-120-harness",
    "question": "¿Harness?",
    "answer": "API estable para interactuar con un componente en tests sin depender de su DOM interno."
  },
  {
    "id": "rapid-121-memory-leak-tipico",
    "question": "¿Memory leak típico?",
    "answer": "Subscription, listener, timer, observer o cache que conserva una vista destruida."
  },
  {
    "id": "rapid-122-correlation-id",
    "question": "¿Correlation ID?",
    "answer": "Identificador que conecta eventos frontend, gateway y backend de una operación."
  },
  {
    "id": "rapid-123-feature-flag",
    "question": "¿Feature flag?",
    "answer": "Control temporal de exposición con owner, métricas y plan de retiro."
  },
  {
    "id": "rapid-124-micro-frontend",
    "question": "¿Micro-frontend?",
    "answer": "Unidad de frontend con ownership y despliegue independiente, a cambio de integración y duplicación."
  },
  {
    "id": "rapid-125-adr",
    "question": "¿ADR?",
