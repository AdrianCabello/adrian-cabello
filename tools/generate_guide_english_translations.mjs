...
const guideUiCopy = [
  ...
  'Code challenge Senior Angular',
  'No evalúan solamente si el código compila. Evalúan cómo aclarás el problema, reducís alcance, modelás estados, verificás riesgos y explicás lo que dejarías para una segunda iteración.',
  'ejercicios',
  'simulacro',
  'Qué te pueden hacer programar',
  'Ejercicios más probables',
  'Practicalos en este orden. Abrí cada uno para ver qué debería quedar terminado y dónde suelen presionar.',
  'Entregables mínimos',
  'Donde te van a presionar',
  'Cómo te puntúan',
  'Rúbrica Senior',
