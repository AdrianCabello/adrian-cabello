...
foundation_chapters = [
    {
        ...
        "qa": [
            ...
            ("¿Shallow copy o deep copy?", "Spread y `Object.assign` copian el primer nivel. Las referencias anidadas siguen compartidas. Elijo una copia profunda solo si el modelo y el costo lo justifican."),
        ],
...
foundation_rapid_fire = [
    ...
    ("¿Temporal Dead Zone?", "Tramo del scope donde `let` o `const` existen pero no pueden leerse antes de inicializarse."),
    ...
    ("¿Shallow copy?", "Copia el primer nivel y comparte referencias anidadas."),
